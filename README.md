...
确认最终修改内容后，先选择模板，再说“使用极简网格生成修订版简历 PDF”。PDF 会读取对应模板文件，只包含修订后的简历，不包含 JD 解读、评审结果或其他分析内容。
...
当前提供 16 套简历模板。使用时只需要选择中文名称；英文文件名是内部标识，无需输入。

| 中文名称 | 适合场景 |
|---|---|
| 经典ATS | 单栏、机器解析友好，适合大多数岗位海投 |
| 学术工程 | 学术、软件、数据和工程岗位 |
| 技术紧凑 | 信息密度较高的工程与技术岗位 |
| 现代侧栏 | 产品、运营、市场和综合岗位 |
| 信息卡片 | 产品、市场和项目管理岗位 |
| 优雅衬线 | 咨询、市场和偏人文岗位 |
| 极简留白 | 设计、创意和审美导向岗位 |
| 职业时间轴 | 需要突出职业成长轨迹的候选人 |
| 瑞士栅格 | 设计、品牌和创意岗位 |
| 商务管理 | 金融、咨询、管理和资深岗位 |
| 杂志编辑 | 品牌、内容和编辑岗位 |
| 商务头像 | 保留人物照片的商务简历 |
| 极简头像 | 保留人物照片的简约简历 |
| 极简网格 | ATS 友好，适合大多数岗位投递 |
| 深蓝商务 | 管理、客户和综合岗位 |
| 暖色编辑 | 市场、品牌、内容和设计岗位 |
